...
import { login } from "../helper/Urlhelper";
...
const Login = () => {
  ...
  return (
    <section className="bg-[url('/2148459511.jpg')] bg-cover bg-center bg-gray-50 dark:bg-gray-900">
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <a
          href="#"
          className="flex flex-col items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white"
        >
          <img className=" mr-2" src="/ios.png" alt="logo" />
          <div>Upsc Serialization</div>
        </a>
