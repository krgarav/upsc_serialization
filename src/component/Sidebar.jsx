            ...
            <div className="flex items-center">
              <div className="flex items-center ms-3">
                <button
                  ...
                  className="p-2 rounded-full bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-200 mr-3"
                >
                  {isDarkMode ? <FaSun color="white" /> : <FaSun />}
                </button>

                <button
                  type="button"
                  className="flex items-center text-sm ring-gray-500 bg-gray-700 ring-2 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                  aria-expanded={dropdownOpen ? "true" : "false"}
                  onClick={toggleDropdown}
                >
                  <span className="sr-only">Open user menu</span>

                  {/* User Role Text with Center Alignment and Ring */}
                  <span className="ml-2 text-white rounded-full py-1 px-2">
                    {user?.user?.role}
                  </span>
